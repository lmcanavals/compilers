...
void addMainFunction(Module *Mod) {
  ...
  FunctionType *MainFuncFty = FunctionType::get(
      Type::getInt32Ty(Mod->getContext()),
      {Type::getInt32Ty(Mod->getContext()),
       Type::getInt8Ty(Mod->getContext())->getPointerTo()->getPointerTo()},
      false);
  Function *MainFunc =
      Function::Create(MainFuncFty, Function::ExternalLinkage, "main", Mod);
  ...
  // main.0:
  BasicBlock *Bb = BasicBlock::Create(Mod->getContext(), "main.0", MainFunc);

  // call void @brainf()
  {
    CallInst *BrainfCall = CallInst::Create(Mod->getFunction("brainf"), "", Bb);
...
int main(int argc, char **argv) {
  ...
  if (JIT) {
    ...
    Function *BrainfFunc = M.getFunction("brainf");
    GenericValue Gv = Ee->runFunction(BrainfFunc, Args);
